...
"""
import re, os
from genxml_manual import MANUAL   # generated by tools/actuators.py

# clock domain -> (class, .sysj file, port it listens on)
CDS = [
    ("GUIInterfaceCD", "GUIInterface", "guiInterface", 10002),
    ("OperatorPanelCD",               "OperatorPanel",               "operatorPanel",               10003),
    ("POSCD",                         "POS",                         "pos",                         10000),
...
SIGNALS = {
    ...
    # One output per actuator, each landing on that machine's manual input.
    "OperatorPanelCD": MANUAL,

    "SystemControllerCD": {
        "guiStatus": "GUIInterfaceCD.Status",
        "productionStatus": "POSCD.productionStatus",
        "resetBL": "BottleLoaderControllerCD.reset",
        "resetCV": "ConveyorControllerCD.reset",
        "resetRT": "RotaryTableControllerCD.reset",
        "resetF1": "Filler1ControllerCD.reset",
        "resetF2": "Filler2ControllerCD.reset",
        "resetLL": "LidLoaderControllerCD.reset",
        "resetCP": "CapperControllerCD.reset",
        "resetLB": "LabellerControllerCD.reset",
        "resetSP": "SplitterControllerCD.reset",
        "resetRC": "RecyclingConveyorControllerCD.reset",
        "resetLR": "LidRemovalControllerCD.reset",
        "resetLD": "LiquidDumperControllerCD.reset",
        "resetBR": "BottleReturnControllerCD.reset",
        "resetRS": "RecyclingStationControllerCD.reset",
        "resetCVP": "ConveyorPlantCD.reset",
        "resetRTP": "RotaryTablePlantCD.reset",
        "resetSPP": "SplitterPlantCD.reset",
        "resetRCP": "RecyclingConveyorPlantCD.reset",
        "modeBL": "BottleLoaderControllerCD.mode",
        "modeCV": "ConveyorControllerCD.mode",
        "modeRT": "RotaryTableControllerCD.mode",
