    ...
    RUN: while(true){
      switch(S19721){
        ...
        case 1 : 
          ...
          bin_thread_1 = new RecyclingCapacity("Bottle collector", BIN_CAPACITY_thread_1);//sysj\bottleReturnPlant.sysj line: 31, column: 2
                  ...
                  if(transferArmRetract.getprestatus()){//sysj\bottleReturnPlant.sysj line: 67, column: 12
                    ...
                    if(arm_thread_1 == ARM_thread_1){//sysj\bottleReturnPlant.sysj line: 71, column: 7
                      ...
                      if(carrying_thread_1) {//sysj\bottleReturnPlant.sysj line: 73, column: 17
                        ...
                        bin_thread_1.add();//sysj\bottleReturnPlant.sysj line: 75, column: 6
                        System.out.println("[BRPlant] Bottle placed in the collector bin (" + bin_thread_1.level() + " of " + BIN_CAPACITY_thread_1 + ").");//sysj\bottleReturnPlant.sysj line: 76, column: 6
                      }
                      if(arm_thread_1 == 0){//sysj\bottleReturnPlant.sysj line: 79, column: 7
                        ...
                        bin_thread_1.serviceReturn(arm_thread_1, carrying_thread_1, pos_thread_1);//sysj\bottleReturnPlant.sysj line: 81, column: 4
                        if(bin_thread_1.full()){//sysj\bottleReturnPlant.sysj line: 82, column: 4
                          collectorBinFull.setPresent();//sysj\bottleReturnPlant.sysj line: 83, column: 5
