...
public class BottleReturnController extends ClockDomain{
  ...
  private int S14334 = 1;
  private int S7119 = 1;
  private int S14045 = 1;
  private int S8274 = 1;
  private int S7144 = 1;
  private int S7128 = 1;
  private int S7123 = 1;
  private int S7225 = 1;
  private int S7220 = 1;
  private int S14332 = 1;
  private int S14140 = 1;
  
  private int[] ends = new int[5];
  private int[] tdone = new int[5];
  
  public void thread14342(int [] tdone, int [] ends){
        switch(S14332){
      case 0 : 
        active[4]=0;
        ends[4]=0;
  ...
  public void thread14341(int [] tdone, int [] ends){
        switch(S14045){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread14340(int [] tdone, int [] ends){
        switch(S7119){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread14338(int [] tdone, int [] ends){
        S14332=1;
    S14140=0;
    if(manual_1.getprestatus()){//sysj/bottleReturnController.sysj line: 94, column: 20
      S14140=1;
  ...
  public void thread14337(int [] tdone, int [] ends){
        S14045=1;
  ...
  public void thread14336(int [] tdone, int [] ends){
        S7119=1;
    if(mode.getprestatus()){//sysj/bottleReturnController.sysj line: 41, column: 12
      if((Integer)(mode.getpreval() == null ? null : ((Integer)mode.getpreval())) == 0){//sysj/bottleReturnController.sysj line: 42, column: 8
        auto_1.setPresent();//sysj/bottleReturnController.sysj line: 42, column: 30
    ...
    RUN: while(true){
      switch(S14334){
        ...
        case 1 : 
          ...
          thread14336(tdone,ends);
          thread14337(tdone,ends);
          thread14338(tdone,ends);
          int biggest14339 = 0;
          if(ends[2]>=biggest14339){
            biggest14339=ends[2];
          }
          if(ends[3]>=biggest14339){
            biggest14339=ends[3];
          }
          if(ends[4]>=biggest14339){
            biggest14339=ends[4];
          }
          if(biggest14339 == 1){
            active[1]=1;
        ...
        case 2 : 
          auto_1.setClear();//sysj/bottleReturnController.sysj line: 37, column: 2
          manual_1.setClear();//sysj/bottleReturnController.sysj line: 37, column: 2
          thread14340(tdone,ends);
          thread14341(tdone,ends);
          thread14342(tdone,ends);
          int biggest14343 = 0;
          if(ends[2]>=biggest14343){
            biggest14343=ends[2];
          }
          if(ends[3]>=biggest14343){
            biggest14343=ends[3];
          }
          if(ends[4]>=biggest14343){
            biggest14343=ends[4];
          }
          if(biggest14343 == 1){
            active[1]=1;
