...
public class LidLoaderPlant extends ClockDomain{
  ...
  private int S86265 = 1;
  
  private int[] ends = new int[4];
  private int[] tdone = new int[4];
  
  public void thread86273(int [] tdone, int [] ends){
        switch(S86265){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread86272(int [] tdone, int [] ends){
        switch(S85405){
      case 0 : 
        active[2]=0;
        ends[2]=0;
    ...
    RUN: while(true){
      switch(S86267){
        ...
        case 1 : 
          S86267=2;
          S86267=2;
          thread86269(tdone,ends);
          thread86270(tdone,ends);
          int biggest86271 = 0;
          if(ends[2]>=biggest86271){
            biggest86271=ends[2];
          }
          if(ends[3]>=biggest86271){
            biggest86271=ends[3];
          }
          if(biggest86271 == 1){
            active[1]=1;
        ...
        case 2 : 
          thread86272(tdone,ends);
          thread86273(tdone,ends);
          int biggest86274 = 0;
          if(ends[2]>=biggest86274){
            biggest86274=ends[2];
          }
          if(ends[3]>=biggest86274){
            biggest86274=ends[3];
          }
          if(biggest86274 == 1){
            active[1]=1;
