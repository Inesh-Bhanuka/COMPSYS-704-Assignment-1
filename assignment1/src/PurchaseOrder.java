...
public class PurchaseOrder implements Serializable {
	...
	public PurchaseOrder(long id, String email) {
		this(id, "PO-" + id, email, email);
	}

	public PurchaseOrder(long id, String orderId, String customerName) {
		this(id, orderId, customerName, "");
	}

	private PurchaseOrder(long id, String orderId, String customerName, String email) {
		this.id = id;
		this.email = email;
