...
public class BottleLoaderPlant extends ClockDomain{
  ...
  public void thread7105(int [] tdone, int [] ends){
        switch(S7097){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread7104(int [] tdone, int [] ends){
        switch(S6969){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread7102(int [] tdone, int [] ends){
        S7097=1;
  ...
  public void thread7101(int [] tdone, int [] ends){
        S6969=1;
    S6941=0;
    armAtDest.setPresent();//sysj\bottleLoaderPlant.sysj line: 23, column: 5
    currsigs.addElement(armAtDest);
    ...
    RUN: while(true){
      switch(S7099){
        ...
        case 1 : 
          S7099=2;
          S7099=2;
          thread7101(tdone,ends);
          thread7102(tdone,ends);
          int biggest7103 = 0;
          if(ends[2]>=biggest7103){
            biggest7103=ends[2];
          }
          if(ends[3]>=biggest7103){
            biggest7103=ends[3];
          }
          if(biggest7103 == 1){
            active[1]=1;
        ...
        case 2 : 
          thread7104(tdone,ends);
          thread7105(tdone,ends);
          int biggest7106 = 0;
          if(ends[2]>=biggest7106){
            biggest7106=ends[2];
          }
          if(ends[3]>=biggest7106){
            biggest7106=ends[3];
          }
          if(biggest7106 == 1){
            active[1]=1;
