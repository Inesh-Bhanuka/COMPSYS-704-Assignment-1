...
public class LidRemovalPlant extends ClockDomain{
  ...
  private int S101751 = 1;
  private int S101317 = 1;
  private int S101445 = 1;
  private int S101699 = 1;
  private int S101749 = 1;
  
  private int[] ends = new int[6];
  private int[] tdone = new int[6];
  
  public void thread101761(int [] tdone, int [] ends){
        switch(S101749){
      case 0 : 
        active[5]=0;
        ends[5]=0;
  ...
  public void thread101760(int [] tdone, int [] ends){
        switch(S101699){
      case 0 : 
        active[4]=0;
        ends[4]=0;
  ...
  public void thread101759(int [] tdone, int [] ends){
        switch(S101445){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread101758(int [] tdone, int [] ends){
        switch(S101317){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread101756(int [] tdone, int [] ends){
        S101749=1;
  ...
  public void thread101755(int [] tdone, int [] ends){
        S101699=1;
  ...
  public void thread101754(int [] tdone, int [] ends){
        S101445=1;
  ...
  public void thread101753(int [] tdone, int [] ends){
        S101317=1;
    ...
    RUN: while(true){
      switch(S101751){
        ...
        case 1 : 
          ...
          thread101753(tdone,ends);
          thread101754(tdone,ends);
          thread101755(tdone,ends);
          thread101756(tdone,ends);
          int biggest101757 = 0;
          if(ends[2]>=biggest101757){
            biggest101757=ends[2];
          }
          if(ends[3]>=biggest101757){
            biggest101757=ends[3];
          }
          if(ends[4]>=biggest101757){
            biggest101757=ends[4];
          }
          if(ends[5]>=biggest101757){
            biggest101757=ends[5];
          }
          if(biggest101757 == 1){
            active[1]=1;
            ends[1]=1;
        ...
        case 2 : 
          lidDropped_1.setClear();//sysj\lidRemovalPlant.sysj line: 40, column: 2
          thread101758(tdone,ends);
          thread101759(tdone,ends);
          thread101760(tdone,ends);
          thread101761(tdone,ends);
          int biggest101762 = 0;
          if(ends[2]>=biggest101762){
            biggest101762=ends[2];
          }
          if(ends[3]>=biggest101762){
            biggest101762=ends[3];
          }
          if(ends[4]>=biggest101762){
            biggest101762=ends[4];
          }
          if(ends[5]>=biggest101762){
            biggest101762=ends[5];
          }
          if(biggest101762 == 1){
            active[1]=1;
            ends[1]=1;
